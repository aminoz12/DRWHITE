...
// Measurement/pixel IDs are read from public env vars at build time. Each block
// renders only when its ID is configured, so the site ships analytics-ready
// without hard-coding any account. Set these in .env.local (see .env.example):
